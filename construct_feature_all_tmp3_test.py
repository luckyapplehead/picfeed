...
train_set_join_user_model= spark.read.csv("gs://dataproc-0e3e0110-db09-4037-98cc-dc355651aba0-asia-southeast1/tensorflow/data/picfeed/train_set_join_user_model/part-00000-59d90ec7-6a27-4356-901d-ea40b3333c49-c000.csv", schema=fieldSchema)
...
print train_feature.take(20)
train_feature_d = spark.createDataFrame(train_feature)
train_feature_d.write.csv("gs://dataproc-0e3e0110-db09-4037-98cc-dc355651aba0-asia-southeast1/tensorflow/data/picfeed/train_feature_test")
