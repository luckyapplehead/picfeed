...
train_set = spark.read.csv("gs://dataproc-0e3e0110-db09-4037-98cc-dc355651aba0-asia-southeast1/tensorflow/data/picfeed/train_feature/part-*", schema=fieldSchema)
...
result_all.select("prediction", "probability", "rawPrediction","features").show(5)
...
model_path = "gs://dataproc-0e3e0110-db09-4037-98cc-dc355651aba0-asia-southeast1/tensorflow/data/picfeed/dt_model"
