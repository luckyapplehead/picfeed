...
remover_res_write = remover_res_new.rdd.map(combine_term)
remover_res_write_d = spark.createDataFrame(remover_res_write, ['urlid', 'title', 's_term_filtered'])
remover_res_write_d.write.csv("gs://dataproc-1228d533-ffe2-4747-a056-8cd396c3db5f-asia-southeast1/data/picfeed/data_term_filtered")
