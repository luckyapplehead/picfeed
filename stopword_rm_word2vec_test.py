...
print "title"
print remover_res_new.head().title.decode("unicode-escape").encode("utf-8")

print "s_term"
for i in range(0, len(remover_res_new.head().s_term_filtered)):
    print remover_res_new.head().s_term_filtered[i].decode("unicode-escape").encode("utf-8"),
